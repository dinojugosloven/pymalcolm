...
class PmacChildPart(builtin.parts.ChildPart):
    ...
    user_program = {
        scanning.infos.MotionTrigger.NONE: {
            PointType.POINT_JOIN:   NO_PROGRAM,
            PointType.START_OF_ROW: NO_PROGRAM,
            PointType.MID_POINT:    NO_PROGRAM,
            PointType.END_OF_ROW:   NO_PROGRAM,
            PointType.TURNAROUND:   NO_PROGRAM,
        },
        scanning.infos.MotionTrigger.ROW_GATE: {
            PointType.POINT_JOIN:   NO_PROGRAM,
            PointType.START_OF_ROW: LIVE_PROGRAM,
            PointType.MID_POINT:    NO_PROGRAM,
            PointType.END_OF_ROW:   ZERO_PROGRAM,
            PointType.TURNAROUND:   NO_PROGRAM,

        },
        scanning.infos.MotionTrigger.EVERY_POINT: {
            PointType.POINT_JOIN:   LIVE_PROGRAM,
            PointType.START_OF_ROW: LIVE_PROGRAM,
            PointType.MID_POINT:    MID_PROGRAM,
            PointType.END_OF_ROW:   DEAD_PROGRAM,
            PointType.TURNAROUND:   ZERO_PROGRAM,
        }
    }
